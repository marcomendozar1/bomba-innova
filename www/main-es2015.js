...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Bomba", function() { return Bomba; });
class Bomba {
    constructor() { }
}
...
const routes = [
    ...
    { path: '', loadChildren: () => Promise.all(/*! import() | cuenta-cuenta-module */[__webpack_require__.e("common"), __webpack_require__.e("cuenta-cuenta-module")]).then(__webpack_require__.bind(null, /*! ./cuenta/cuenta.module */ "./src/app/cuenta/cuenta.module.ts")).then(m => m.CuentaComponentModule) },
    { path: '', loadChildren: () => Promise.all(/*! import() | home-admin-home-admin-module */[__webpack_require__.e("common"), __webpack_require__.e("home-admin-home-admin-module")]).then(__webpack_require__.bind(null, /*! ./home-admin/home-admin.module */ "./src/app/home-admin/home-admin.module.ts")).then(m => m.HomeAdminComponentModule) },
    { path: '', loadChildren: () => __webpack_require__.e(/*! import() | menu-users-tabs-user-tabs-user-module */ "menu-users-tabs-user-tabs-user-module").then(__webpack_require__.bind(null, /*! ./menu-users/tabs-user/tabs-user.module */ "./src/app/menu-users/tabs-user/tabs-user.module.ts")).then(m => m.TabsUserComponentModule) },
    { path: '', loadChildren: () => __webpack_require__.e(/*! import() | menu-list-tabs-list-tabs-list-module */ "menu-list-tabs-list-tabs-list-module").then(__webpack_require__.bind(null, /*! ./menu-list/tabs-list/tabs-list.module */ "./src/app/menu-list/tabs-list/tabs-list.module.ts")).then(m => m.TabsListComponentModule) },
    { path: '', loadChildren: () => __webpack_require__.e(/*! import() | menu-bombas-tabs-bombas-tabs-bomba-module */ "menu-bombas-tabs-bombas-tabs-bomba-module").then(__webpack_require__.bind(null, /*! ./menu-bombas/tabs-bombas/tabs-bomba.module */ "./src/app/menu-bombas/tabs-bombas/tabs-bomba.module.ts")).then(m => m.TabsBombaComponentModule) },
...
/* harmony import */ var _angular_fire_storage__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/fire/storage */ "./node_modules/@angular/fire/__ivy_ngcc__/fesm2015/angular-fire-storage.js");
...
/* harmony import */ var _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/geolocation/ngx */ "./node_modules/@ionic-native/geolocation/__ivy_ngcc__/ngx/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].firebase),
        ...
        providers: [
            ...
            _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_7__["SplashScreen"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_15__["Geolocation"],
...
/* harmony import */ var _DAO_user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_DAO/user */ "./src/app/_DAO/user.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_services_conexion_bomba_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/conexion-bomba.service */ "./src/app/services/conexion-bomba.service.ts");
...
let ModalComponent = class ModalComponent {
    constructor(conexion, modalController, navParams, geolocation) {
...
ModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./modal.component.scss */ "./src/app/modal/modal.component.scss")).default]
    })
], ModalComponent);
...
let AuthService = class AuthService {
    ...
    RegisterUser(email, password) {
        return this.ngFireAuth.createUserWithEmailAndPassword(email, password).then((newUser) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConexionBombaService", function() { return ConexionBombaService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let ConexionBombaService = class ConexionBombaService {
    constructor(afs) {
        this.afs = afs;
    ...
    initializeItems() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const items = yield this.afs.collection('Bomba')
    ...
    deleteItem(item) {
        this.itemDoc = this.afs.doc(`Bomba/${item.id}`);
        this.itemDoc.delete();
    }
    updateItem(item) {
        this.itemDoc = this.afs.doc(`Bomba/${item.id}`);
...
ConexionBombaService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
ConexionBombaService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
module.exports = __webpack_require__(/*! C:\Users\Luis Antonio\Documents\Ionic\bomba-inova\src\main.ts */"./src/main.ts");
